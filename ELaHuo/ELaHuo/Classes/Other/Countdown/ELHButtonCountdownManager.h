...
@class ELHCountdownTask;
NS_ASSUME_NONNULL_BEGIN
@interface ELHButtonCountdownManager : NSObject
/**
 *  获取单例
 *
 *  @return 该类的唯一实例
 ...
 */
- (BOOL)countdownTaskExistWithKey:(NSString *)akey task:(ELHCountdownTask * _Nullable * _Nullable)task;
