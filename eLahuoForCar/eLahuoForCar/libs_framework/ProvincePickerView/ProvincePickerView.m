...
- (void) addToolBarItem {
    ...
    UIBarButtonItem * item3 = [[UIBarButtonItem alloc] initWithTitle:@"开户城市" style:UIBarButtonItemStyleDone target:self action:nil];
    ...
    toolBar.items = @[item0, item1, item3, item1, item2];
    
    // 设置颜色
    NSMutableDictionary *titleAttrs = [NSMutableDictionary dictionary];
    titleAttrs[NSForegroundColorAttributeName] = [UIColor blackColor];
    NSMutableDictionary *titleAttrs1 = [NSMutableDictionary dictionary];
    titleAttrs1[NSForegroundColorAttributeName] = [UIColor colorWithRed:24 / 255.0 green:123 / 255.0 blue:255 / 255.0 alpha:1.0];
    [item0 setTitleTextAttributes:titleAttrs1 forState:UIControlStateNormal];
    [item0 setTitleTextAttributes:titleAttrs1 forState:UIControlStateHighlighted];
    [item3 setTitleTextAttributes:titleAttrs forState:UIControlStateNormal];
    [item3 setTitleTextAttributes:titleAttrs forState:UIControlStateHighlighted];
    [item2 setTitleTextAttributes:titleAttrs1 forState:UIControlStateNormal];
    [item2 setTitleTextAttributes:titleAttrs1 forState:UIControlStateHighlighted];
